const a = "This file has been derived from Unicode Common Locale Data Repository (CLDR) files (http://cldr.unicode.org). See the copyright and permission notice in the Unicode-Data-Files-LICENSE.txt available at the same location as this file or visit http://www.unicode.org/copyright.html", e = "43.0.0", n = "2023-09-28T11:39:07.908Z", t = {
  aa: "Afar",
  ab: "Abkhazian",
  ace: "Achinese",
  ach: "Acoli",
  ...
  dayPeriodRules: b,
  calendarPreference: k
};
export {
  n as __buildtime,
  a as __license,
  e as __version,
  k as calendarPreference,
  p as currencyDigits,
  h as currencyFormat,
